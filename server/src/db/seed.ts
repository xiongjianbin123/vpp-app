...
const seedDevices = [
  ...
  {
    id: 'D002', name: '储能系统-A', type: '储能系统', status: '在线', capacity: 20, energy_capacity: 40, current_power: 15.2, soc: 72, location: '北京市海淀区', last_update: '2026-03-14 10:30:00',
    extra_data: { soh: 88, connectionType: 'MODBUS TCP', batteryType: 'LFP磷酸铁锂', batterySpec: '100Ah / 3.2V', bmsModel: '科陆电子 BMS-2000', pcsModel: '科士达 PCS-200KW', emsModel: '本地EMS', investmentCost: 4800, commissionDate: '2023-11-15', warrantyYears: 5, cycleCount: 892, maxCellVoltage: 3311, minCellVoltage: 3248, cellMaxTemp: 28.6, cellMinTemp: 25.3, temperature: 23.5, humidity: 48, bmsAlarms: ['SOH低于90%，建议安排电池健康诊断'] },
  },
  ...
  {
    id: 'D007', name: '储能系统-B', type: '储能系统', status: '在线', capacity: 15, energy_capacity: 30, current_power: 8.5, soc: 58, location: '天津市滨海新区', last_update: '2026-03-14 10:30:00',
    extra_data: { soh: 92, connectionType: 'MODBUS TCP', batteryType: 'LFP磷酸铁锂', batterySpec: '100Ah / 3.2V', bmsModel: '科陆电子 BMS-2000', pcsModel: '科士达 PCS-150KW', emsModel: '本地EMS', investmentCost: 3600, commissionDate: '2024-03-20', warrantyYears: 5, cycleCount: 645, maxCellVoltage: 3298, minCellVoltage: 3259, cellMaxTemp: 29.2, cellMinTemp: 26.8, temperature: 24.1, humidity: 51, bmsAlarms: [] },
  },
